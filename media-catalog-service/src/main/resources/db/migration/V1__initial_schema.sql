...
COMMENT ON COLUMN media_item.thumbnail IS 'URL of the thumbnail image';
...
COMMENT ON COLUMN media_playlist.thumbnail IS 'URL of the thumbnail image';

CREATE TABLE playlist_item_mapping
(
    playlist_id   TEXT NOT NULL REFERENCES media_playlist (id),
...
(
    media_item_id TEXT PRIMARY KEY REFERENCES media_item (id),
...
(
    media_playlist_id TEXT    NOT NULL REFERENCES media_playlist (id),
    language_code     CHAR(2) NOT NULL,
    title             TEXT    NOT NULL,
    description       TEXT,
...
(
    media_playlist_id TEXT PRIMARY KEY REFERENCES media_playlist (id),
